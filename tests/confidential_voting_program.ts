...
import { ConfidentialVotingProgram } from "../target/types/confidential_voting_program";
...
describe("ConfidentialVotingProgram", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ConfidentialVotingProgram as Program<ConfidentialVotingProgram>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ConfidentialVotingProgram>,
